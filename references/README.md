...
| Tromp & Farnebäck, *Combinatorics of Go*, CG 2006 (rev. 2016) | held | the 2016 revision from <https://tromp.github.io/go/gostate.pdf>, saved as `data/tromp-farneback-combinatorics-of-go.pdf` (gitignored), §7 and Lemma 2 read 2026-09-11; Lemma 2 (C-7, C-8); Table 7 carries the game counts (C-9, C-23); its ruleset permits multi-stone suicide, and it reports the 2×2 count as brute-force enumeration "independently verified" by an unnamed party |
| Tromp, *Solving 2x2 go*, web page with C source `2x2.c` | held | <https://tromp.github.io/java/go/twoxtwo.html>, read 2026-09-11; the program behind the 2×2 count (C-9): area rules, positional superko, suicide rejected outright, a game counted at the second consecutive pass; its `ngames` is a full count only with alpha-beta cutting disabled (`CUT 0`) |
